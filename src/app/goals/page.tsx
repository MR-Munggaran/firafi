...
export default async function GoalsPage() {
  ...
  return (
    <>
      ...
      {goals.length === 0 ? (
        <div className="bg-white rounded-3xl py-16 text-center mb-5 animate-slide-up" style={{ boxShadow: "var(--shadow-card)" }}>
          <p className="text-4xl mb-3">🌟</p>
          <p className="text-sm font-semibold text-stone-600 mb-1">Belum ada target impian</p>
          <p className="text-xs text-stone-400">Buat target pertama kalian di bawah!</p>
        </div>
      ) : (
