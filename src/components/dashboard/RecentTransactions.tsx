...
// mapping kategori → emoji (kategori disimpan sebagai string "🍔 Makan" dll)
  ...
  return (
    <section className="mb-6 animate-slide-up">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link href="/transactions" className="text-xs text-rose-400 font-medium">
          Lihat semua →
        </Link>
      </div>
        ...
        {transactions.length === 0 ? (
          <div className="py-10 text-center">
            ...
            <Link
              ...
              className="inline-block mt-3 text-xs text-rose-400 font-medium"
            >
          ...
          <ul>
            {transactions.map((tx, i) => {
              ...
              return (
                ...
                >
                  <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-sm flex-shrink-0 ${isIncome ? "bg-emerald-50" : "bg-rose-50"}`}>
                  ...
                  <p className={`text-sm font-semibold flex-shrink-0 ${isIncome ? "text-emerald-500" : "text-rose-500"}`}>
